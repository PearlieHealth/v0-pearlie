      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-3">
            {content && <p>{content}</p>}
            <p>
              Every practice on Pearlie is independently checked against the General Dental Council register before
              appearing on the platform. Clinics do not pay to appear higher in results — matching is based on your
              treatment needs, location, and preferences. The service is completely free for patients.
            </p>
          </div>
        </div>
      </div>
