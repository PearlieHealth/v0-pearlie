  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
      ...
      <div style={{ flex: 1, height: 8, borderRadius: 4, background: "#d1d5db", overflow: "hidden" }}>
        <div style={{ width: `${pct}%`, height: "100%", borderRadius: 4, background: highlight ? "linear-gradient(90deg, #2563eb, #3b82f6)" : "#d1d5db", transition: "width .3s" }} />
      </div>
    </div>
  )
}
...
function Tag({ label, active }: { label: string; active?: boolean }) {
  return (
    <span style={{ display: "inline-block", padding: "5px 12px", borderRadius: 8, fontSize: 12, fontWeight: active ? 600 : 400, background: active ? "rgba(37,99,235,.08)" : "#f9fafb", color: active ? "#2563eb" : "#6b7280", border: `1px solid ${active ? "rgba(37,99,235,.2)" : "#d1d5db"}`, lineHeight: 1.3 }}>
      {label}
    </span>
  )
}
  ...
  return (
    <div style={{ background: "#ffffff", border: "1px solid #d1d5db", borderRadius: 16, padding: "24px 22px 20px", display: "flex", flexDirection: "column", boxShadow: "0 1px 4px rgba(0,0,0,.08)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
        <div style={{ width: 34, height: 34, borderRadius: 10, background: "rgba(37,99,235,.08)", display: "flex", alignItems: "center", justifyContent: "center", color: "#2563eb", flexShrink: 0 }}>{icon}</div>
...
export default function ForClinicsPage() {
  ...
  const greenBtn = {
    ...
    boxShadow: "0 0 20px rgba(37,99,235,.15), 0 4px 12px rgba(0,0,0,.08)",
  } as const
  const outlineBtn = {
    display: "inline-flex",
    alignItems: "center",
  ...
  return (
    <div className="for-clinics" style={{ background: navy, color: "#1f2937", minHeight: "100vh", fontFamily: "var(--font-jakarta), 'Plus Jakarta Sans', sans-serif", WebkitFontSmoothing: "antialiased" }}>
        ...
        <div style={maxW}>
          ...
          <div className="fc-stats-bar" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 16, padding: "32px 24px", borderTop: `1px solid ${cardBorder}`, borderBottom: `1px solid ${cardBorder}` }}>
            {["No contracts", "No setup fee", "Cancel anytime"].map((item) => (
              <span key={item} style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(37,99,235,.07)", border: "1px solid rgba(37,99,235,.2)", padding: "10px 22px", borderRadius: 24, color: "#1d4ed8", fontSize: 15, fontWeight: 700 }}>
                <Check size={16} /> {item}
              </span>
            ))}
          </div>
          ...
          <div className="fc-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
            ...
            <div style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 16, padding: "28px 24px", display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
                <div style={{ width: 42, height: 42, borderRadius: 12, background: `rgba(37,99,235,.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: teal }}><FileText size={22} /></div>
              ...
              <div style={{ background: "rgba(0,0,0,.04)", borderRadius: 12, padding: "16px 18px", flex: 1 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {[{ label: "Clear pricing before treatment", selected: true }, { label: "A calm, reassuring environment", selected: true }, { label: "Strong reputation and reviews", selected: false }].map((opt) => (
                    <div key={opt.label} style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 10px", borderRadius: 8, background: opt.selected ? `rgba(37,99,235,.1)` : "rgba(0,0,0,.03)", border: `1px solid ${opt.selected ? "rgba(37,99,235,.25)" : "rgba(0,0,0,.06)"}` }}>
            ...
            <div style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 16, padding: "28px 24px", display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
                <div style={{ width: 42, height: 42, borderRadius: 12, background: `rgba(37,99,235,.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: teal }}><Brain size={22} /></div>
              ...
              <div style={{ background: "rgba(0,0,0,.04)", borderRadius: 12, padding: "16px 18px", flex: 1 }}>
                ...
                {[{ label: "Treatment fit", score: 95, color: teal }, { label: "Cost alignment", score: 88, color: tealLight }, { label: "Location", score: 82, color: "#60a5fa" }, { label: "Clinic values match", score: 90, color: teal }].map((m) => (
            ...
            <div style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 16, padding: "28px 24px", display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
                <div style={{ width: 42, height: 42, borderRadius: 12, background: `rgba(37,99,235,.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: teal }}><Zap size={22} /></div>
              ...
              <div style={{ background: "rgba(0,0,0,.04)", borderRadius: 12, padding: "16px 18px", flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  ...
                  <span style={{ marginLeft: "auto", fontSize: 10, fontWeight: 700, color: teal, background: `rgba(37,99,235,.12)`, padding: "3px 8px", borderRadius: 6 }}>92% match</span>
                </div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {["Invisalign", "Quite anxious", "Flexible range", "Within a week", "Clear pricing", "Afternoons", "Up to 5 mi", "Cost concern"].map((l) => (
                    <span key={l} style={{ fontSize: 10, fontWeight: 500, padding: "3px 8px", borderRadius: 6, background: `rgba(37,99,235,.1)`, color: tealLight, border: `1px solid rgba(37,99,235,.2)` }}>{l}</span>
                  ))}
                </div>
              </div>
            </div>
          ...
          <div className="fc-insights-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 16 }}>
            ...
            <VisualInsightCard icon={<Clock size={16} />} title="How ready they are" question="When are you looking to start treatment?">
              <div style={{ display: "flex", alignItems: "stretch", gap: 0, marginBottom: 8 }}>
                {[{ label: "ASAP", color: teal }, { label: "This week", color: tealLight }, { label: "Few weeks", color: "#60a5fa" }, { label: "Exploring", color: "#6b7280" }].map((t, i) => (
            ...
            <VisualInsightCard icon={<Calendar size={16} />} title="Preferred visit times" question="When would you prefer appointments?">
              <div style={{ display: "flex", gap: 10, marginBottom: 8 }}>
                {[{ label: "Morning", sub: "Before 12pm", icon: "9am", active: false }, { label: "Afternoon", sub: "12 – 5pm", icon: "2pm", active: true }, { label: "Weekend", sub: "Sat / Sun", icon: "Sat", active: true }].map((slot) => (
                  <div key={slot.label} style={{ flex: 1, textAlign: "center", padding: "14px 8px 12px", borderRadius: 12, background: slot.active ? `rgba(37,99,235,.1)` : "rgba(0,0,0,.03)", border: `1px solid ${slot.active ? "rgba(37,99,235,.25)" : "rgba(0,0,0,.06)"}` }}>
            ...
            <VisualInsightCard icon={<MapPin size={16} />} title="Location flexibility" question="How far are you willing to travel?">
              <div style={{ marginBottom: 8 }}>
                {[{ label: "Close to home / work", dist: "1.5 mi", idx: 0 }, { label: "Travel a bit", dist: "5 mi", idx: 1 }, { label: "Travel further for right clinic", dist: "5+ mi", idx: 2 }].map((loc) => (
                  <div key={loc.label} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 10, marginBottom: 4, background: loc.idx === 1 ? `rgba(37,99,235,.08)` : "transparent", border: loc.idx === 1 ? `1px solid rgba(37,99,235,.15)` : "1px solid transparent" }}>
            ...
            <div style={{ overflowX: "auto" }}>
              <table className="fc-table" style={{ width: "100%", minWidth: 500, borderCollapse: "collapse", fontSize: 15 }}>
                <thead><tr>
                  ...
                  <th style={{ textAlign: "center", padding: "18px 20px", color: teal, fontWeight: 700, fontSize: 14, borderBottom: `2px solid ${teal}`, background: `rgba(37,99,235,.04)` }}>Pearlie</th>
                </tr></thead>
                <tbody>
                  {[
                    ...
                    <tr key={row.feature}>
                      ...
                      <td style={{ textAlign: "center", padding: "16px 20px", color: teal, fontWeight: 600, fontSize: 14, borderBottom: `1px solid rgba(0,0,0,.04)`, background: `rgba(37,99,235,.03)` }}>{row.pearlie}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <section className="fc-section" style={sec}>
        <div style={{ ...maxW, maxWidth: 800 }}>
          <div style={{ textAlign: "center", marginBottom: 12 }}>
            <span style={{ display: "inline-block", background: `rgba(37,99,235,.1)`, color: teal, fontWeight: 700, fontSize: 13, padding: "6px 16px", borderRadius: 20, textTransform: "uppercase", letterSpacing: "0.04em" }}>Zero risk</span>
          </div>
      ...
      <section className="fc-section" style={secAlt}>
        <div style={maxW}>
          <div style={{ textAlign: "center", marginBottom: 12 }}>
            <span style={{ display: "inline-block", background: `rgba(37,99,235,.1)`, color: teal, fontWeight: 700, fontSize: 13, padding: "6px 16px", borderRadius: 20, textTransform: "uppercase", letterSpacing: "0.04em" }}>Bonus: free visibility</span>
          </div>
          ...
          <div className="fc-visibility-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
            ...
            <div style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 16, padding: "24px 22px 20px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                <div style={{ width: 34, height: 34, borderRadius: 10, background: `rgba(37,99,235,.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: teal, flexShrink: 0 }}><TrendingUp size={16} /></div>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: 6, height: 80, padding: "0 4px", marginBottom: 12 }}>
                {[18, 25, 22, 35, 40, 38, 52, 60, 55, 70, 78, 85].map((h, i) => (
                  <div key={i} style={{ flex: 1, height: `${h}%`, borderRadius: "3px 3px 0 0", background: i >= 9 ? `linear-gradient(180deg, ${teal}, rgba(37,99,235,.4))` : `rgba(37,99,235,.15)` }} />
                ))}
              </div>
            ...
            <table className="fc-compare-table" style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
              <thead>
                <tr style={{ borderBottom: "1px solid rgba(0,0,0,.08)" }}>
                  ...
                  <th style={{ textAlign: "center", padding: "16px 16px", color: teal, fontWeight: 700, fontSize: 14, background: "rgba(37,99,235,.04)" }}>
              ...
              <tbody>
                ...
                <tr style={{ background: "rgba(37,99,235,.06)" }}>
                  ...
                  <td style={{ textAlign: "center", padding: "14px 16px", borderBottom: "1px solid rgba(0,0,0,.04)", background: "rgba(37,99,235,.04)" }}><Check size={18} style={{ color: teal }} /></td>
                  <td style={{ textAlign: "center", padding: "14px 16px", borderBottom: "1px solid rgba(0,0,0,.04)" }}><Check size={18} style={{ color: teal }} /></td>
                </tr>
                {[
                  ...
                  <tr key={row.feature} style={{ borderBottom: "1px solid rgba(0,0,0,.04)" }}>
                    ...
                    {[row.starter, row.standard, row.premium].map((val, i) => (
                      <td key={i} style={{ textAlign: "center", padding: "12px 16px", background: i === 1 ? "rgba(37,99,235,.04)" : undefined }}>
                ...
                <tr style={{ borderTop: "1px solid rgba(0,0,0,.08)" }}>
                  ...
                  <td style={{ textAlign: "center", padding: "20px 12px", background: "rgba(37,99,235,.04)" }}>
                    <Link href="/signup" style={{ ...greenBtn, padding: "10px 20px", fontSize: 13, borderRadius: 10 }}>
                      Start free trial
                    </Link>
                  </td>
              ...
              return (
                <>
                  <div className="fc-roi-output-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 24 }}>
                    ...
                    <div style={{ background: "rgba(37,99,235,.06)", border: "1px solid rgba(37,99,235,.15)", borderRadius: 14, padding: "20px 16px", textAlign: "center" }}>
          ...
          <div className="fc-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {[
              ...
              <div key={s.step} style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 16, padding: "28px 22px", textAlign: "center" }}>
                <div style={{ width: 44, height: 44, borderRadius: 12, background: `rgba(37,99,235,.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: teal, margin: "0 auto 14px" }}>{s.icon}</div>
          ...
          <div className="fc-testimonials-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24, maxWidth: 880, margin: "48px auto 0" }}>
            {[
              ...
              <div key={t.name} style={{ background: cardBg, border: `1px solid ${cardBorder}`, borderRadius: 20, padding: "36px 30px", position: "relative" }}>
                <Quote size={28} style={{ color: `rgba(37,99,235,.1)`, position: "absolute", top: 28, right: 28 }} />
      ...
      {/* ══════════ 13. FINAL CTA ══════════ */}
      <section className="fc-section" style={{ padding: "100px 24px 140px", background: `linear-gradient(180deg, rgba(37,99,235,.04) 0%, rgba(8,13,27,0) 100%)`, textAlign: "center" }}>
        <div style={maxW}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 10, marginTop: 20 }}>
            {["No contracts", "No setup fee", "Cancel anytime"].map((item) => (
              <span key={item} style={{ display: "inline-flex", alignItems: "center", gap: 5, background: "rgba(37,99,235,.07)", border: "1px solid rgba(37,99,235,.2)", padding: "6px 14px", borderRadius: 20, color: "#1d4ed8", fontSize: 13, fontWeight: 600 }}>
                <Check size={13} /> {item}
              </span>
            ))}
          </div>
