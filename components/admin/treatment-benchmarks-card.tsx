      ...
      <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
            ...
            return (
              <div key={row.treatment} className="border rounded-lg p-3 space-y-2">
                ...
                <div className="flex h-1.5 rounded-full overflow-hidden bg-muted">
                  {row.leads > 0 && (
                    <>
                      <div className="bg-[#0d1019] transition-all" style={{ width: "100%" }} />
                      <div className="bg-[#161b26] transition-all" style={{ width: `${(row.matchesShown / row.leads) * 100}%` }} />
                      <div className="bg-[#1f2633] transition-all" style={{ width: `${(row.clinicClicks / row.leads) * 100}%` }} />
                      <div className="bg-[#2a3140] transition-all" style={{ width: `${(row.bookRequests / row.leads) * 100}%` }} />
                    </>
                  )}
                </div>
              </div>
        ...
        <div className="mt-4 pt-3 border-t">
          <p className="text-xs text-muted-foreground">
            Platform average conversion: <strong className="text-foreground">{avgConversion.toFixed(0)}%</strong>
