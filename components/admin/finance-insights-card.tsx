      ...
      <CardContent className="p-4 md:p-6 pt-0 md:pt-0 space-y-5">
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-bold text-[#1a2332]">{costSensitivePct.toFixed(0)}%</span>
          ...
          <div className="flex gap-4 mt-2 text-xs text-muted-foreground">
            <span>
              <strong className="text-[#1a2332]">{comfortRangeCount}</strong> have a flexible range
            </span>
            <span>
              <strong className="text-[#1a2332]">{strictBudgetCount}</strong> have strict budgets
            </span>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-muted/50 rounded-lg p-3 text-center">
                <p className="text-lg font-bold text-[#1a2332]">{monthlyNo}</p>
        ...
        {strictBudgetCount > 0 && (
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-muted/50 rounded-lg p-3 text-center">
                <p className="text-lg font-bold text-[#1a2332]">{budgetShareRangeCount}</p>
