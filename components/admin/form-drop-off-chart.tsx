...
export function FormDropOffChart({ events = [] }: FormDropOffChartProps) {
  ...
  // Match by step_name instead of step_number for more accurate tracking
  const stepsData = [
    { step: 1, name: "Treatment Selection" },
    { step: 2, name: "Postcode" },
    { step: 3, name: "Decision Values" },
    { step: 4, name: "Outcome Priority" },
    { step: 5, name: "Readiness" },
    { step: 6, name: "Budget" },
    { step: 7, name: "Contact Details" },
  ]
  ...
  const stepStats = stepsData.map((stepData) => {
    ...
    const abandoned = formEvents.filter((e) => {
      ...
      return lastStep === stepData.step || lastStep === String(stepData.step) || lastStep === stepData.name
    }).length
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-orange-800">
                ...
                <strong>
                  Step {highestDropOff.step}: {highestDropOff.name}
                </strong>
