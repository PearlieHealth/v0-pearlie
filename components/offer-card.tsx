    ...
    <Card className="flex-shrink-0 w-[280px] overflow-hidden hover:shadow-lg transition-shadow">
      {clinicImage && (
        <div className="relative h-40 w-full bg-muted">
          <ClinicImage src={clinicImage} alt={clinic.name} fill className="object-cover" fallbackClassName="w-full h-full flex items-center justify-center bg-[#0d1019]" sizes="280px" />
        </div>
      )}
