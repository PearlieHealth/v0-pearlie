        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {standards.map((standard) => (
              <div key={standard.title} className="bg-white rounded-xl border border-border/50 p-5">
                <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-[#004443]/5 mb-3">
                  <standard.icon className="w-4.5 h-4.5 text-[#004443]" />
                </div>
