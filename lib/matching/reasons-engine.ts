...
const TAG_TO_GROUP: Record<string, ReasonGroup> = {
  ...
  FALLBACK_PATIENT_COMFORT: "GROUP_GENERIC_FALLBACK",
  FALLBACK_WELCOMING_TEAM: "GROUP_GENERIC_FALLBACK",
  FALLBACK_TRUSTED_PRACTICE: "GROUP_GENERIC_FALLBACK",
  FALLBACK_EASY_ACCESS: "GROUP_GENERIC_FALLBACK",
  FALLBACK_MODERN_FACILITIES: "GROUP_GENERIC_FALLBACK",
  FALLBACK_FLEXIBLE_REBOOKING: "GROUP_GENERIC_FALLBACK",
  FALLBACK_FAMILY_FRIENDLY: "GROUP_GENERIC_FALLBACK",
}
