...
export function normalizeClinic(clinicRow: any, filterKeys: string[] = []): ClinicProfile {
  ...
  return {
    ...
    rating: Number(clinicRow.google_rating || clinicRow.rating) || undefined,
    reviewCount: clinicRow.google_review_count || clinicRow.google_reviews_count || clinicRow.review_count || clinicRow.reviews_count || clinicRow.reviewCount || 0,
