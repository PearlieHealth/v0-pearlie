  ...
  constructor() {
    super({
      ...
      float sparkleNoise(vec3 seed, float time) {
        ...
        return 0.8 + finalBrightness * 0.4;
      }
      ...
      void main() {
        ...
        vec3 creamColor = vec3(0.85, 0.82, 0.76); // Warm cream/beige
        gl_FragColor = vec4(creamColor, mix(alpha * 0.4, sparkleBrightness - 1.1, uTransition));
      }`,
      uniforms: {
