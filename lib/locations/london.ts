...
export const LONDON_AREAS: LondonArea[] = [
  {
    ...
    quickFacts:
      "Harley Street has been London's medical quarter since the 1840s and remains the UK's most recognised address for specialist dental care — including some of the country's most sought-after cosmetic and implant dentists. Consultations here tend to run £100–£250, roughly 30–50% above the London average, reflecting the concentration of specialist qualifications and advanced technology. Despite the premium, demand keeps growing: cosmetic dentistry enquiries in the W1 postcode area have risen sharply in recent years, driven largely by Invisalign and veneer treatments. The area is served by four Tube stations within a five-minute walk, making it one of the most accessible dental districts in the country.",
    faq: [
      {
...
export const LONDON_REGIONS: LondonRegion[] = [
  {
    ...
    quickFacts:
      "Central London has the highest concentration of dental practitioners anywhere in the UK. The W1 postcode alone contains more GDC-registered dental practices than many entire cities. Harley Street, Mayfair, and Soho together account for a significant share of the UK's cosmetic dentistry market, with treatments like Invisalign, veneers, and implants driving the majority of bookings. Private check-ups in the area range from £80–£250, with specialist consultations often higher. Despite the density of options, most Londoners still report finding it difficult to choose a dentist — a gap Pearlie was built to close. The area is exceptionally well-connected by Tube, making it accessible from virtually anywhere in London.",
