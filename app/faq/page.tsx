          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                ...
                <AccordionItem value="item-2" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-3" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-4" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-5" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-6" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-7" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-8" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-9" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                  ...
                  <AccordionContent className="text-white/80 leading-relaxed">
                    ...
                    <a href="https://www.nhs.uk/service-search/find-a-dentist" target="_blank" rel="noopener noreferrer" className="text-[var(--primary)] hover:underline">
                      NHS Find a Dentist
                    </a>.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-10" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-11" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
                ...
                <AccordionItem value="item-12" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--dark-teal-bg)] text-white [&_svg]:text-white/70">
                  <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline">
