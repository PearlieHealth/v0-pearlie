...
export default function FAQPage() {
  const faqItems = [
    ...
    { question: "What if I don't find the right clinic?", answer: "You can adjust your preferences or submit another match request at any time. Pearlie's network includes 100+ practices across London. We focus on quality over quantity, with every clinic verified as GDC-registered." },
              ...
              <Accordion type="single" collapsible className="space-y-4">
                ...
                <AccordionItem value="item-11" className="border-none rounded-lg px-4 sm:px-6 bg-[var(--cream)]">
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed">
                    ...
                    includes 100+ practices across London. We focus on quality over quantity, with every clinic verified as GDC-registered.
                  </AccordionContent>
                </AccordionItem>
