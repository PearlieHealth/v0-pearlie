    ...
    <div className="min-h-screen bg-[#FEFEFE] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-[#323141] mb-2">Welcome back</h1>
          <p className="text-[#323141]/70">Sign in to view your matches and conversations.</p>
        </div>
        ...
        {magicLinkSent ? (
          <div className="text-center space-y-4">
            ...
            <h2 className="text-xl font-semibold text-[#323141]">Check your email</h2>
            <p className="text-[#323141]/70">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <Label htmlFor="email" className="text-sm font-medium text-[#323141]">
                Email address
              </Label>
              <Input
                id="email"
              ...
              <Button
                ...
                className="w-full h-14 text-lg font-semibold rounded-2xl bg-gradient-to-r from-[#907EFF] to-[#ED64A6] text-white border-0"
              >
                {isLoading ? (
        ...
        <div className="text-center mt-8">
          <Link href="/" className="text-sm text-[#323141]/50 hover:text-[#323141] transition-colors">
            Back to home
          </Link>
        </div>
      </div>
