        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/for-clinics" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                For Clinics
              </Link>
            </nav>
            <MobileNavMenu />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">When you use Pearlie, we may collect:</p>

              <h3 className="text-base font-medium text-foreground mb-2">Information you provide</h3>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">Clinics are only notified when you:</p>
              <ul className="list-disc pl-6 space-y-1.5 text-muted-foreground mb-3">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">We process your data under:</p>
              <ul className="list-disc pl-6 space-y-1.5 text-muted-foreground mb-3">
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed">You may withdraw consent at any time.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed font-medium">We never sell personal data.</p>
            </section>
