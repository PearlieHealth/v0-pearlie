          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-14">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5 text-balance leading-tight">
          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#004443]">
          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#004443] mb-4">
