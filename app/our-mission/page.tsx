          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-14">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-medium tracking-tighter text-white mb-5 text-balance leading-tight">
          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-heading font-medium tracking-tighter text-[#004443]">
          ...
          <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-heading font-medium tracking-tighter text-[#004443] mb-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-heading font-medium tracking-tighter text-white mb-6">
